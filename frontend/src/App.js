...
function App() {
  const stripePromise=loadStripe("pk_test_51OmH6fSCPSi3s2RgWjkDcyeQqJuZKZAW7i9T69H49KoZM8u7dQQa5cgLgd4Mtex2cgmFrbHzjd7V6b1vUYWkUgqB00rl7SFK2y"
  );
  ...
  const router = createBrowserRouter(
    //creates routes form the elements passed to it
    createRoutesFromElements(
      //defines the route components that matches all path "/" and renders the main components
      //exact properties ensure that the routes match exacately what you gave in path
  ...
  return (
    <div className="App">
      {/*this ensures that the routing functionality */}
